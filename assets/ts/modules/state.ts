...
export function commandBar() {
  return document.querySelector<HTMLElement>("[data-lw-commandbar]");
}
...
export function fileExplorerEl() {
  return document.querySelector<HTMLElement>("[data-lw-explorer]");
}
...
export function mainContentEl() {
  return document.querySelector<HTMLElement>("[data-lw-main]");
}
